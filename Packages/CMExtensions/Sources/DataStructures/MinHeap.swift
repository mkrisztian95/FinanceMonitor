...
/// A min heap is a binary tree where every node has a value less than or equal to its children
public struct MinHeap<Element>: ExpressibleByArrayLiteral where Element: Comparable {
